...
import 'package:draw_face/setDrawingArea.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void saveSketchToImage(List<SetDrawingArea> points) async {
    ...
    final canvas = Canvas(
        sketchRecorder, Rect.fromPoints(Offset(0.0, 0.0), Offset(200, 200)));
  ...
  void retrieveResponse(var base64Image) async {
    ...
    //:5000/predict
    var urlFlaskServer = 'http://192.168.0.103:5000/predict';
...
//4 set FLASK_APP=drawFaceFlask.py
//5. set FLASK_ENV=development
//6. flask run --host=192.168.0.103
